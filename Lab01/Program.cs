...
// Финансовый мини-расчёт
Console.WriteLine();
int scholarship = 1200;
int monthlyExpenses = 1000;
int money = scholarship - monthlyExpenses;
const int MonthsInSemester = 4;
int moneyLeftMonth = MonthsInSemester * money;
Console.WriteLine($"Остаток в месяц: {money} руб.");
Console.WriteLine($"Итого остаток за семестр: {moneyLeftMonth} руб.");
...
int remains = totalMinutes % minutesPerLesson;
Console.WriteLine($"500 минут = {fullLessons} полных занятий + {remains} минут.");